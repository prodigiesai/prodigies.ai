...
<div class="<?php echo $sliderClass; ?>">
    <div id="jssor_1"
         style="position: relative; margin: 0px auto; top: 0px; left: 0px; width: <?php echo $width; ?>; height: <?php echo $height; ?>; overflow: hidden; visibility: hidden;">
        ...
        <?php if ($images): ?>
            <div data-u="slides"
                 style="cursor: default; position: relative; top: 0px; left: 0px; width: <?php echo $width; ?>; height: <?php echo $height; ?>; overflow: hidden;">
