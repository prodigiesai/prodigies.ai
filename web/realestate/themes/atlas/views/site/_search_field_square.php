<div class="<?php echo $divClass; ?>">
    ...
    ?>
    <div class="<?php echo $textClass; ?>"><?php echo Yii::t('common', 'Square range') . ', ' . tc("site_square"); ?>
        :
    </div>
        ...
        echo '</div>';
            ...
            <div class="<?php echo $controlClass; ?>">
                <input onblur="changeSearch();" type="number" id="squareMin" name="square_min"
                       class="width120 search-input-new" placeholder="<?php echo tc('Square from') ?>"
                       value="<?php echo CHtml::encode($squareMin); ?>"/>&nbsp;
                <input onblur="changeSearch();" type="number" id="squareMax" name="square_max"
                       class="width120 search-input-new" placeholder="<?php echo tc('Square to') ?>"
                       value="<?php echo CHtml::encode($squareMax); ?>"/>&nbsp;
