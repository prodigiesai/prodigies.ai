...
$spro_tour_content['assistant']['.spro-header-menu'] = array(
    ...
    "intro" => __("Assistant adds AI to your site building process and lets you create content with just a few clicks (look for the AI option while editing your posts/pages). <br /><br />Assistant also helps you with several aspects of building and maintaning your WordPress website.", "softaculous-pro"),  
    "position" => "bottom", 
);

$spro_tour_content['assistant']['#spro-tours'] = array(
    "title" => __("Tours", "softaculous-pro"),  
    "intro" => __("Tours highlights and explains important options in WordPress that you will need while managing your site. <br /><br />You can replay the tours when needed.", "softaculous-pro"),  
    "position" => "right", 
);
...
$spro_tour_content['assistant']['#toplevel_page_assistant'] = array(
    ...
    "intro" => __("Assistant resides here, when you are unable to find something or having a hard time understanding a feature in WordPress we should be able to help you. <br /><br />Visit this page anytime.", "softaculous-pro"),  
    "position" => "right", 
);
...
$spro_tour_content['sidebar']['#menu-dashboard'] = array(
    ...
    "intro" => __("The Dashboard is your website's command center, providing a concise summary of its activity, such as site health, recent updates, comments, and statistics. <br /><br />Several plugins also display quick summary like orders, products, etc within the dashboard. <br /><br />You can also check for Updates from the sub-menu.", "softaculous-pro"),  
    "position" => "right", 
);

$spro_tour_content['sidebar']['#menu-posts'] = array(
    "title" => __("Posts", "softaculous-pro"),  
    "intro" => __("Manage your blog posts here. <br /><br />Posts are typically utilized for blog posts, news updates, or articles, organized in a chronological order.", "softaculous-pro"),
    "position" => "right", 
); 

$spro_tour_content['sidebar']['#menu-media'] = array(
    "title" => __("Media Library", "softaculous-pro"),  
    "intro" => __("Manage media files like images, audio, videos, etc. here. <br /><br />Media uploaded from anywhere on your site can be managed here.", "softaculous-pro"),  
    "position" => "right", 
);

$spro_tour_content['sidebar']['#menu-pages'] = array(
    "title" => __("Pages", "softaculous-pro"),
    "intro" => __("Pages are static content sections such as Home, About Us, Contact, Services, etc. <br /><br />Use this menu to add, edit, delete your pages.", "softaculous-pro"),
    "position" => "right", 
); 

$spro_tour_content['sidebar']['#menu-comments'] = array(
    "title" => __("Comments", "softaculous-pro"),  
    "intro" => __("Here you can moderate comments posted by visitors on your posts. <br /><br />You can one click disable comments  for your entire site from the Assistant dashboard.", "softaculous-pro"),
    "position" => "right", 
); 

$spro_tour_content['sidebar']['#menu-appearance'] = array(
    "title" => __("Appearance", "softaculous-pro"),
    "intro" => __("Personalize your site's appearance effortlessly. <br /><br />Explore themes, customize headers, background, colors, manage widgets and menus to customize your site's look and feel.", "softaculous-pro"),  
    "position" => "right", 
); 

$spro_tour_content['sidebar']['#menu-plugins'] = array(
    "title" => __("Plugins", "softaculous-pro"),
    "intro" => __("Unlock endless possibilities for your website with plugins. <br /><br />Easily search, add or delete plugins to enhance your site's functionality.", "softaculous-pro"),  
    "position" => "right", 
); 
...
$spro_tour_content['sidebar']['#menu-settings'] = array(
    "title" => __("Settings", "softaculous-pro"),
    "intro" => __("Advanced settings for your site can be managed here. <br /><br />These settings include site title, tagline, site url, writing, reading, discussion, media, permalinks and more.<br /><br />Some plugins also add their settings page in this menu.", "softaculous-pro"),
    "position" => "right", 
);
...
$spro_tour_content['plugins']['td.plugin-title'] = array(
    ...
    "intro" => __("You can perform actions for your plugins like Activate, Deactivate, Update, Delete, Plugin Settings and more.. <br /><br />It is recommended to delete plugins that you do not plan to use and keep all your plugins up to date.", "softaculous-pro"),  
    "position" => "bottom",
);
...
$spro_tour_content['themes']['.theme-actions'] = array(
    ...
    "intro" => __("You can perform actions for your theme like Activate, Live Preview, Customize and more <br /><br />It is recommended to delete themes that you do not plan to use and keep all your themes up to date.", "softaculous-pro"),  
    "position" => "bottom",
);
...
$spro_tour_content['dashboard']['#menu-dashboard'] = array(
    "title" => __("Dashboard", "softaculous-pro"),  
    "intro" => __("The Dashboard is your website's command center, providing a concise summary of its activity, such as site health, recent updates, comments, and statistics. <br /><br />Several plugins also display quick summary like orders, products, etc within the dashboard.", "softaculous-pro"),  
    "position" => "right", 
);

$spro_tour_content['dashboard']['#dashboard_site_health'] = array(
    "title" => __("Site Health", "softaculous-pro"),  
    "intro" => __("Here you can get insights on the overall performance and security of your website. <br /><br />It offers recommendations and troubleshooting tools to help you maintain an efficient and secure site.", "softaculous-pro"),  
    "position" => "right", 
);
...
$spro_tour_content['dashboard']['#dashboard_quick_press'] = array(
    ...
    "intro" => __("Use this section for capturing ideas as they come to you, quickly jot down the ideas for new posts. <br /><br />You can later access these drafts from the Posts section and continue editing them in the full post editor.", "softaculous-pro"),
    "position" => "left", 
);
...
$spro_tour_content['dashboard']['#dashboard_primary'] = array(
    ...
    "intro" => __("This widget is a valuable resource for staying informed about the latest happenings in the WordPress community and connecting with other WordPress enthusiasts. <br /><br />Here you will find updates on new releases, upcoming features, security updates, and general news about the WordPress community. <br /><br />This section also shows upcoming WordPress events such as WordCamps, local meetups, and other community gatherings.", "softaculous-pro"),  
    "position" => "left", 
);
...
$spro_tour_content['dashboard']['#screen-options-link-wrap'] = array(
    ...
    "intro" => __("This useful feature allows you to select the screen elements that you would like to show or hide by using the checkboxes. <br /><br />You will find this option on several pages across your site.", "softaculous-pro"),
    "position" => "bottom", 
);
