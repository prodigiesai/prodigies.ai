...
class EAjaxUpload extends CWidget {
	...
	public function run(){
		...
		Yii::app()->clientScript->registerScriptFile($baseUrl . '/fileuploader.js', CClientScript::POS_BEGIN);
		...
		$config = array(
			...
			'fileTemplate' => '<li><span class="qq-upload-file"></span><span class="qq-upload-spinner"></span><span class="qq-upload-size"></span>
				<a class="qq-upload-cancel" href="#">'.tc('Cancel').'</a><span class="qq-upload-failed-text">'.tc('Error. Repeat attempt later').'</span></li>',
		);
