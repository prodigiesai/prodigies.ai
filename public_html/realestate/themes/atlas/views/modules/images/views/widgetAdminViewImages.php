            ...
            if ($this->withMain && $image['is_main'] || !$this->withMain && !$image['is_main'] || !$image['is_main']) {
                ...
                <div class="image-item" id="image_<?php echo $image['id']; ?>">
                    ...
                    <div class="image-link-item">
                        ...
                        <a class="rotateImageLink" link-id="<?php echo $image['id']; ?>" href="javascript: void(0);"
                           title="<?php echo tc('Rotate'); ?>">
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/rotate.png" width="16"
                                 height="16" alt="<?php echo tc('Rotate'); ?>" title="<?php echo tc('Rotate'); ?>"/>
                        </a>
                    ...
                    <div class="image-comment-input">
                        ...
                        <a class="deleteImageLink" link-id="<?php echo $image['id']; ?>" href="javascript: void(0);">
                            <img src="<?php echo Yii::app()->theme->baseUrl; ?>/images/delete.png" width="16"
                                 height="16" alt="<?php echo tc('Delete'); ?>" title="<?php echo tc('Delete'); ?>"/>&nbsp;
                            <?php echo tc('Delete'); ?>
                        </a>
                    </div>
                </div>
